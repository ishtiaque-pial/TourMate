...
import com.example.pial.tourmate.activityPackage.FirstActivity;
...
public class EventActivity extends AppCompatActivity {
    ...
    public void logout(MenuItem item)
    {
        ...
        loginSharedPref.destroy();
        Intent intent=new Intent(EventActivity.this, FirstActivity.class);
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            {
                case 0:
                    CurrentEvent tab1=new CurrentEvent();
                    return tab1;
                case 1:
                    PastEvent tab2=new PastEvent();
                    return tab2;
                default:
                    return null;
            }
